...
<style>
  body {
    background: linear-gradient(to right, #43587eff, #cfd1d5ff);
    overflow: hidden;
  }
  ...
  <div class="container">
    ...
    <div class="form-section w-100">
      <form action="{{ route('adminlogin.login') }}" method="POST">
        ...
        <p style="color: gray; text-align: center;">Welcome Back ! Login to Continue</p>
        @if ($errors->has('email'))
        <div style="color: red; margin-bottom: 15px;" class="mt-5">
          {{ $errors->first('email') }}
        </div>
        @endif
